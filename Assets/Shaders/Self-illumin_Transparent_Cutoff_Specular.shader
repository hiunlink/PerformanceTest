// Self-illumin + Transparent + Cutoff + Specular
// Nic@atlantis

Shader "Custom/Self-illumin_Transparent_Cutoff_Specular"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
		#pragma surface surf SimpleBlinnPhong alphatest:_Cutoff addshadow vertex:vert tessellate:tessEdge tessphong:_Smoothness 
